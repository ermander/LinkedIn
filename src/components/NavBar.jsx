...
<<<<<<< Updated upstream
    ...
    render() {
        return (
            <div>                
  <Navbar  className="navbar mt-0 " style={{height: "55px"}} variant="dark">
...
<FormControl type="text" placeholder="Search" className="mr-sm-2" style={{width:"250px", height:"33px"}} />
     ...
     <Nav className="ml-auto  ">
      <Nav.Link href="#home"  ><AiOutlineHome  style={{fontSize:"20px"}} /><div style={{fontSize:"13px"}}>Home</div></Nav.Link>
      <Nav.Link href="#network"  > <AiOutlineTeam style={{fontSize:"20px"}}/><div style={{fontSize:"13px"}}>My Network</div></Nav.Link>
...
<Nav.Link href="#work" ><BsGrid3X3GapFill style={{fontSize:"20px"}}/><div style={{fontSize:"13px"}}> Work <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" data-supported-dps="16x16" fill="currentColor" width="16" height="16" focusable="false">
  <path d="M8.8 10.66L14 5.12a.07.07 0 00-.07-.12H2.07a.07.07 0 00-.07.12l5.2 5.54a1.1 1.1 0 001.6 0z"></path></svg></div></Nav.Link>
  <Nav.Link href="#learning" ><AiOutlinePlaySquare style={{fontSize:"20px"}}/><div style={{fontSize:"13px"}}>Learning</div></Nav.Link>
    </Nav>
  </Navbar>
    </div>
        )
      ...
      >
        <Container>
          ...
          <Form>
            ...
            />
            <Dropdown.Menu show={this.props.show}>
             {this.props.users}
            </Dropdown.Menu>
            </Dropdown>
          </Form>
          <Nav className="ml-auto  ">
            <Link className="navIcon nav-link" to="/home">
