...
const schema = Yup.object({
  role : Yup.string().required('Required').min(3,'Minimum 3 characters required'),
  company : Yup.string().required('Required').min(2,'Minimum 2 characters required'),
...
class LinkedInForm extends React.Component {
  ...
  sendData =async(values)=>{
    let response = await fetch('https://striveschool.herokuapp.com/api/profile/user26/experiences',{
      method:'POST',
